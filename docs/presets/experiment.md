...
| 专四冲刺（近似词书）（book-tem4） | cet6+toefl | 9137 | 12376 | 73.8% |
| 专八冲刺（近似词书）（book-tem8） | gre+toefl+ielts | 9137（词频截断） | 19512 | 46.8% |
...
| 合并去重后总词数 | 12842 |
| 截断至（与专四冲刺同词数） | 9137 |
| 截断点词条 | sack（frq=4467, bnc=4693） |
| 截断点下一词条 | stack（frq=4466, bnc=6113） |
