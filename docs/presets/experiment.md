...
> 生成时间：2026-08-14T18:20:48.622Z（脚本：scripts/presets/analyze.mjs）
...
|---|---|
| 全量数据行 | 770611 |
| 清洗后唯一词条（term 形状合法 + 释义非空 + 去重） | 401224 |
| 重复丢弃（term 小写去重） | 0 |
| 释义超长截断行 | 0 |
...
|---|---|---|---|---|
| Tier 0 | 7195 | 861 KB | 290 KB | 228 KB |
| Tier 1 | 58244 | 4.5 MB | 1.7 MB | 1.3 MB |
| Tier 2 | 401224 | 26.4 MB | 8.8 MB | 6.6 MB |
