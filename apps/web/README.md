...
`computeLearnedTodayCount`（事件投影）。首页展示「今日新卡额度剩余 N 张」——
有待学词时说明徽标数字（未截断到期数）与每日实际可学队列的关系；复习队列
为空但额度已恢复（如 Day 2 早晨）时也展示，避免「今日无待学词」被误读为
无学习额度（RAY-352）。
...
- **1–3** 评分（三档默认：不认识 / 模糊 / 认识）或 **1–4** 或 **A / H / G / E** 评分（四档 Anki 传统：Again / Hard / Good / Easy），评分后进入下一张卡；
