...
/** 键盘（按键指示，RAY-362：保留 key icon，文案“按 1-3 评分”已删除） */
export function KeyboardIcon({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M6 8h.01M10 8h.01M14 8h.01M18 8h.01M6 12h.01M10 12h.01M14 12h.01M18 12h.01M8 16h12" />
    </svg>
  );
}
